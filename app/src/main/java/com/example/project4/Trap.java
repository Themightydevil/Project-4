...
public class Trap extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(new Songs(getString(R.string.iconic_song), getString(R.string.iconic_artist),
                getString(R.string.iconic_remix), R.drawable.omar_khan, R.raw.iconic));
        songs.add(new Songs(getString(R.string.candy_shop_song), getString(R.string.candy_shop_artist),
                getString(R.string.candy_shop_remix), R.drawable.cent_50, R.raw.candy_shop));


        // Set our customer Adapter to display the layout.
        SongsAdapter itemsAdapter = new SongsAdapter(this, songs, R.color.category_trap);
        ...
        rootView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    mMediaPlayer = MediaPlayer.create(Trap.this, song.getAudioResourceId());
                    mMediaPlayer.start();
