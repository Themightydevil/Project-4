...
public class Edm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songs.add(new Songs(getString(R.string.attracting_lies_song), getString(R.string.attracting_lies_artist),
                getString(R.string.attracting_lies_remix), R.drawable.alunageorge, R.raw.attracting_lies));
        songs.add(new Songs(getString(R.string.satisfaction_song), getString(R.string.satisfaction_artist),
                getString(R.string.satisfaction_remix), R.drawable.benny_benassi, R.raw.spaceship));


        // Set our customer Adapter to display the layout.
        SongsAdapter itemsAdapter = new SongsAdapter(this, songs, R.color.category_edm);
        ...
        rootView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    mMediaPlayer = MediaPlayer.create(Edm.this, song.getAudioResourceId());
                    mMediaPlayer.start();
